    ...
    <>
      <nav className={`navbar ${scrolled ? "scrolled" : ""}`}>
        <div className="nav-container">
          {/* LOGO */}
          <div className="logo-box" onClick={(e) => handleLinkClick(e, "home")}>
          ...
          <div className={`nav-menu ${isOpen ? "nav-active" : ""}`}>
            ...
            {/* Mobile View Button - Only shows inside hamburger */}
            <button onClick={openBookingForm} className="header-btn mobile-nav-btn">Book Now</button>
          </div>

          {/* Desktop View Button - Stays outside menu */}
          <button onClick={openBookingForm} className="header-btn desktop-only">Book Now</button>
        </div>
      </nav>
